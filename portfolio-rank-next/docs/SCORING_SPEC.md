SCORING_SPEC.md
This document defines the scoring engine. No scoring code may be written until this spec is complete. Formulas are locked here. The AI layer reads from this output — it cannot change it.
...
6.0 – 7.9 → Strong  
8.0 – 10.0 → Elite
Internally, subscores are still calculated on a 0–100 scale for precision, then converted to the 0–10 scale for the final displayed score.
Example:
Internal score: 74  
Displayed score: 7.4
...
Each subscore is calculated internally on a 0–100 scale. The weighted average is then converted to a 0–10 score for display.
Subscore
Weight
What it measures
Diversification
30%
Spread across sectors and number of holdings
Concentration Risk
30%
How much weight sits in the top 1–3 holdings
Volatility Alignment
25%
Whether portfolio beta matches user risk tolerance
Market Exposure
15%
Exposure to broad market vs niche/illiquid assets
